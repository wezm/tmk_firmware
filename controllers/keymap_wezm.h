...
const uint8_t PROGMEM keymaps[][MATRIX_COLS][MATRIX_ROWS] = {
    ...
    KEYMAP(\
         ...
         GRV ,TRNS,FN2 ,FN3 ,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN7 ,TRNS,TRNS,TRNS,   TRNS,TRNS,VOLU,    TRNS,TRNS,TRNS,TRNS, \
         TRNS,TRNS,FN4 ,TRNS,TRNS,TRNS,HOME,PGDN,PGUP,END ,FN8 ,TRNS,TRNS,TRNS,   TRNS,TRNS,VOLD,    TRNS,TRNS,TRNS,TRNS, \
